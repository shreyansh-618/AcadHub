  ...
  switch (status) {
    ...
    case "pending_embedding":
      return {
        ...
        className: STATUS_STYLES.pending_embedding,
      };
    case "failed":
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let docsCount = 0;
        // Fetch documents
        const docsRes = await fetch(`${API_ROOT}/resources`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
        ...
        const [recommendationsRes, trendingRes, statsRes] =
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-8 mb-8">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <p className="text-slate-600">
              Based on your activity, searches, and the subjects you keep
              returning to.
            </p>
          </div>
          {recommendations.length === 0 ? (
            <p className="text-slate-600">
              No recommendations yet. Start exploring resources.
            </p>
          ) : (
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-8 mb-8">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <p className="text-slate-600">
              Popular resources students in your semester are downloading right
              now.
            </p>
          </div>
          {trending.length === 0 ? (
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-8">
          ...
          {documents.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {documents.map((doc) => {
                const statusMeta = getProcessingStatusMeta(
